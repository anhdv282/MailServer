<%-- 
    Document   : login
    Created on : Jul 16, 2014, 9:10:19 AM
    Author     : DANG
--%>
...
<html class="bg-blue">
    ...
    <body class="bg-blue">
        ...
        <div class="form-box" id="login-box">
            ...
            <s:form action="checkLogin" method="POST" theme="simple">
...
<!--                    <button type="submit" class="btn bg-olive btn-block">Sign me in</button>  -->
                    <s:submit value="Sign me in" cssClass="btn bg-olive btn-block" type="submit"/>
