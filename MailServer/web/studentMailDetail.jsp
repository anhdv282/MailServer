<%-- 
    Document   : studentMailDetail
    Created on : Jul 26, 2014, 4:44:28 PM
    Author     : DANG
--%>
                                        ...
                                        <div class="col-md-3 col-sm-4">
                                            ...
                                            <div style="margin-top: 15px;">
                                                <ul class="nav nav-pills nav-stacked">
                                                    ...
                                                    <li><a href="<s:url action="viewStudentInbox"/>"><i class="fa fa-inbox"></i> Inbox ()</a></li>
                                                    
                                                    <li class="active"><a href="<s:url action="viewStudentSent"/>"><i class="fa fa-mail-forward"></i> Sent</a></li>
